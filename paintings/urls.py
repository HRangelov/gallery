...
from paintings.views import details_or_comment_painting, like_painting, edit_painting, delete_painting, \
    create_painting, PaintingsListView

urlpatterns = [
    # path('', list_painting, name='list paintings'),
    path('', PaintingsListView.as_view(), name='list paintings'),
